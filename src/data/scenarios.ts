...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    relatedArticles: ["the-chain-of-command-in-nonprofit-governance", "what-does-a-nonprofit-board-actually-do"],
  ...
  },
  {
    ...
    facts: "At each quarterly board meeting of a $4M elder-care nonprofit, the Treasurer distributes a single-page document showing only three numbers: 'Total Cash,' 'Total Expenses,' and 'Net Surplus.' When a new board member, Director Martinez (who has a background in banking), asks to see a detailed Statement of Activities, a Balance Sheet, and a budget-to-actual variance report, the Treasurer brushes the request aside, saying: 'We've operated this way for fifteen years, we trust our staff, and we don't need to overcomplicate things with boring spreadsheets.'",
  ...
  },
  {
    ...
    risk: "Missing receipts are a major red flag for both the IRS and the California Attorney General's Registry of Charitable Trusts. Unsubstantiated executive charges can be legally reclassified by the IRS as 'automatic excess benefit transactions' and 'taxable personal income' to the executive, carrying immediate fines. If the board ignores this, the board members can be sued for breach of fiduciary care and failure to protect charitable assets.",
  ...
  },
  {
    ...
    relatedArticles: ["what-insurance-does-a-nonprofit-board-need", "fiduciary-duties-care-loyalty-obedience", "what-does-a-nonprofit-board-actually-do"],
